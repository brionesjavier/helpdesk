                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 text-center">
                    ...
                    @if (auth()->user()->getAllPermissions()->isNotEmpty())
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 ">
                            ...
                            <!-- Tickets Pendientes -->
                            <div class="bg-gradient-to-r from-red-400 to-red-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold">Tickets Pendientes</p>
                                <p class="text-4xl mt-2">{{ $ticketsPendientes }}</p>
                            </div>
                        
                            <!-- Tickets En Proceso -->
                            <div class="bg-gradient-to-r from-blue-400 to-blue-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold">Tickets En Proceso</p>
                                <p class="text-4xl mt-2">{{ $ticketsEnProceso }}</p>
                            </div>
                        
                            <!-- Tickets Solucionados -->
                            <div class="bg-gradient-to-r from-green-400 to-green-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold">Tickets Solucionados</p>
                                <p class="text-4xl mt-2">{{ $ticketsSolucionados }}</p>
                            </div>
                        
                            <!-- Tickets Cancelados -->
                            <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 text-center">
                    ...
                    @if (auth()->user()->getAllPermissions()->isNotEmpty())
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-6">
                            ...
                            <div class="bg-gradient-to-r from-purple-400 to-purple-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold"> Tickets en Gestión</p>
                                <p class="text-4xl mt-2">{{ $ticketsGestion }}</p>
                            </div>
                        
                            <!-- Tickets En Proceso -->
                            <div class="bg-gradient-to-r from-indigo-400 to-indigo-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold">Tickets En Proceso</p>
                                <p class="text-4xl mt-2">{{ $ticketsGestionProcess }}</p>
                            </div>

                            <!-- Tickets Objetados -->
                            <div class="bg-gradient-to-r from-pink-400 to-pink-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold">Tickets Objetados</p>
                                <p class="text-4xl mt-2">{{ $ticketsGestionObjet }}</p>
                            </div>
                        
                            <!-- Tickets Solucionados -->
                            <div class="bg-gradient-to-r from-emerald-400 to-emerald-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105"">
                                <p class="text-xl font-semibold">Tickets Solucionados</p>
                                <p class="text-4xl mt-2">{{ $ticketsGestionSolved }}</p>
                            </div>
                        
                            <!-- Tickets Cancelados -->
                            <div class="bg-gradient-to-r from-amber-400 to-amber-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold">Tickets en Cancelados</p>
                                <p class="text-4xl mt-2">{{ $ticketsGestionCancel }}</p>
                            </div>

                             <!-- Tickets en Bandeja -->
                             <div class="bg-gradient-to-r from-stone-400 to-stone-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if (auth()->user()->getAllPermissions()->isNotEmpty())
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:cols-6 gap-6">
                            ...
                            <!-- Tickets En gestión -->
                            <div class="bg-gradient-to-r from-violet-400 to-violet-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                            ...
                            <div class="bg-gradient-to-r from-sky-400 to-sky-600 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if (auth()->user()->getAllPermissions()->isNotEmpty())
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                            ...
                            <!-- Tickets Pendientes -->
                            <div class="bg-gradient-to-r from-red-400 to-rose-600 text-white p-6 rounded-full shadow-full hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold text-center">Pendientes</p>
                                <p class="text-4xl mt-2 text-center">{{ $totalTicketsPendientesDelDia }}</p>
                            </div>
                        
                            <!-- Tickets En gestión -->
                            <div class="bg-gradient-to-r from-purple-400 to-violet-600 text-white p-6 rounded-full shadow-full hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold text-center">En Gestión</p>
                                <p class="text-4xl mt-2 text-center">{{ $totalTicketsEnGestionDelDia }}</p>
                            </div>

                            <!-- Total de Tickets en algún proceso -->
                            <div class="bg-gradient-to-r from-blue-400 to-sky-600 text-white p-6 rounded-full shadow-full hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold text-center">En Proceso</p>
                                <p class="text-4xl mt-2 text-center">{{ $totalTicketsEnProcesoDelDia }}</p>
                            </div>

                            <!-- Total de Tickets en objetado -->
                            <div class="bg-gradient-to-r from-pink-400 to-pink-600 text-white p-6 rounded-full shadow-full hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                                <p class="text-xl font-semibold text-center">Objetado</p>
                                <p class="text-4xl mt-2 text-center">{{ $totalTicketsObjetadoDelDia }}</p>
                            </div>
                        
                            <!-- Tickets Solucionados -->
                            <div class="bg-gradient-to-r from-emerald-400 to-emerald-600 text-white p-6 rounded-full shadow-full hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                            ...
                            <!-- Tickets Cancelados -->
                            <div class="bg-gradient-to-r from-amber-400 to-amber-600 text-white p-6 rounded-full shadow-lg hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
