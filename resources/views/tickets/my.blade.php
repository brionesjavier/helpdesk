                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse ($tickets as $index => $ticket)
                                    <tr
                                        ...
                                        <td
                                            class="px-6 py-3 text-sm border-b border-gray-300 dark:border-gray-700 flex space-x-2">
                                            @can('tickets.show')
                                                <a href="{{ route('tickets.show', $ticket) }}"
                                            ...
                                            @can('tickets.destroy')
                                                @if ($ticket->state_id == 8 || $ticket->state_id == 7)
                                                    <form action="{{ route('tickets.destroy', $ticket) }}" method="POST"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-md shadow-sm transition duration-300 ease-in-out">Eliminar</button>
                                                    </form>
                                                @endif
                                            @endcan
                                        </td>
