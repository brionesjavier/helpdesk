                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @can('tickets.solve.submit')
                        ...
                        <form action="{{ route('tickets.solve.submit', $ticket) }}" method="POST"
                            onsubmit="return confirm('¿Estás seguro de que deseas solucionar el ticket?');">
                            @csrf
                            @method('post')
                            ...
                            <textarea name="content" placeholder="Solucionar requerimiento y detallar proceso" class="mt-2 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-500 placeholder-gray-400 dark:placeholder-gray-600 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"required></textarea>
